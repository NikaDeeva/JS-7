...
function createCards(colors) {
    return colors.map((color)=>` <div class="card">
        <div class="swatch"
        data-hex="${color.hex}";
        data-rgb="${color.rgb}";
...
palleteContainer.innerHTML = createCards((0, _dataJsonDefault.default));
...
},{"./data.json":"aLYkf","./style.css":"bhJkM","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"aLYkf":[function(require,module,exports,__globalThis) {
...
},{}],"bhJkM":[function() {},{}],"gkKU3":[function(require,module,exports,__globalThis) {
